package com.caremoa.helper.domain.repository;
...
/**
* @packageName    : com.caremoa.helper.domain.repository
* @fileName       : HelperRepository.java
* @author         : 이병관
* @date           : 2023.05.24
* @description    :
* ===========================================================
...
*/
public interface HelperOfferRepository extends JpaRepository<HelperOffer, Long> {
